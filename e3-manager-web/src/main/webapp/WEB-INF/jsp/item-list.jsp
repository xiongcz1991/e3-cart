...
</table>                                                       <!--"modal:true,closed:true,iconCls:'icon-save',href:'/rest/page/item-edit'" -->
...
<script>
    ...
    function getSelectionsIds(){
    	...
    	console.log(sels);
        var itemId = sels[0].id;
        var url = "modal:true,closed:true,iconCls:'icon-save',href:'/rest/page/item-edit"+itemId+"'"
    	var ids = [];
    	for(var i in sels){
    		ids.push(sels[i].id);
    	}
